...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Anton Grachev"
  # spec.authors            = { "Anton Grachev" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/Anton Grachev"
  ...
  spec.source       = { :git => "https://github.com/beobyte/ImageLoader.git", :commit => "ef0c13f37e9f4a3798f18ff26421f2fc15ed45af" }
